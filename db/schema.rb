...
ActiveRecord::Schema.define(version: 2022_04_22_162626) do
  ...
  create_table "employees_teams", id: false, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  add_foreign_key "groups", "blind_dates"

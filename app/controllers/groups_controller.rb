class GroupsController < ApplicationController
  ...
  def create
    if(group_params[:employees].blank?)
    else
      blind_date = Group.create_lunch_group(group_params)
      @groups = Group.where(blind_date_id: blind_date.id)
    end
